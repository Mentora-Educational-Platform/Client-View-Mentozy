...
-- RLS Policies
-- 1. Anyone authenticated can view organisations they own or belong to
...
-- 2. Owners can update their organisations
...
-- 3. Authenticated admins/users can insert new organisations
